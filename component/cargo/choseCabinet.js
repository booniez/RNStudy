...
export default class choseCabinet extends Component < {} > {
  constructor(props) {
    super(props);
    ...
    return(
      <View style={styles.container}>
        <View style={styles.topInfoView} >
          <Image source={{uri: 'toy_1'}} style={{width:56*Util.size.width/375,height:56*Util.size.width/375,marginLeft:110*Util.size.width/375,marginRight:18*Util.size.width/375,marginTop:19*Util.size.height/667,marginBottom:18*Util.size.height/667}} />
          <Text style={{fontSize:14,color:'#333'}} >遥控汽车</Text>
        </View>

        <View style={styles.tipView} >
          <Text style={{fontSize:16,color:'#333'}} >请选择需要上架到的格子</Text>
        ...
        <View style={{borderColor:'#F7F7F7',borderWidth:Util.pixel*2}} />
  ...
  _toyMsg() {
    ...
    this.props.navigation.navigate('addCargoSuccess');
  }
}
const styles = StyleSheet.create({
  ...
  topInfoView: {
    ...
    borderBottomWidth: Util.pixel*5,
